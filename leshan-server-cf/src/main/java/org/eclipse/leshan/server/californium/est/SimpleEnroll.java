...
public class SimpleEnroll extends CoapResource {
    private final CoapEstHandler coapEstHandler;

    public SimpleEnroll(CoapEstHandler coapEstHandler) {
        super("sen");
            ...
            if (accept == 281 || accept == -1) {
                try {
                    ...
                    byte[] data = this.coapEstHandler
                            .simpleEnroll(peerAddress, senderIdentity, accept, contentFormat, reqPayload);
