...
public class LinkFormatHelperTest {
    ...
    public void encode_bootstrap_security_object() {
        ...
        assertEquals("</>;lwm2m=1.0,</0>;ver=1.1,</0/0>;ssid=111,</0/1>,</0/2>;ssid=222,</0/3>;ssid=333", strLinks);
    ...
    public void encode_bootstrap_root() {
        ...
        assertEquals(
                "</>;lwm2m=1.0,</0>;ver=1.1,</0/0>;ssid=111,</0/1>,</0/2>;ssid=222,</0/3>;ssid=333,</1>;ver=2.0,</1/0>;ssid=333,</2>;ver=2.0,</3/0>",
                strLinks);
    }
